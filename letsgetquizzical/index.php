					...
					<div class="row">
									...
									<form action="home.php" method="POST">
										<fieldset>
											<div class="row" aria-describedby="tooltip" id="tooltipB">
												...
												<?php
													if ($error == "email") {
														echo "<div id='tooltip' role='tooltip'>Email Not Registered</div><br/>";
													}
													if ($error == "password") {
														echo "<div id='tooltip' role='tooltip'>Wrong Password</div><br/>";
													}
												?>
											</div>
											...
											<div class="row mt-3">
												<div class="col-12">
													<input type="hidden" id="custId" name="feed" value="local">
													<button id="loginButton" type="submit" class="btn btn-dark float-right" name="login" >Login <i class="fa fa-angle-right"></i></button>
												</div>
											</div>
										</fieldset>
									</form>
						...
						<div class="col-12 col-md-6 mt-3 mt-md-0">
							<div class="card">
								...
								<div class="card-body">
									<form action=" home.php?feed=local" method="POST">
										<fieldset>
											<div class="row">
												<div class="col-12 col-lg-6">
											...
											<div class="row mt-3">
												<div class="col-12">
													<input type="hidden" id="custId" name="feed" value="local">
													<button type="submit" class="btn btn-dark float-right" name="register">Register <i class="fa fa-angle-right"></i></button>
												</div>
											</div>
										</fieldset>
									</form>
